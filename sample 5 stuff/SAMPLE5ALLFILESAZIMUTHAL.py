...
#FILE 462 DOCS
file462_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 5 stuff/FILE639/FILE6391STORDER.xlsx'
file462_root3peak='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 5 stuff/FILE639/FILE639ROOT3PEAK.xlsx'
file462_2ndorder='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 5 stuff/FILE639/FILE6392NDORDER.xlsx'

#FILE 510 DOCS
file510_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 5 stuff/FILE650/FILE6501STORDER.xlsx'
file510_root3peak='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 5 stuff/FILE650/FILE650ROOT3PEAK.xlsx'
file510_2ndorder='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 5 stuff/FILE650/FILE6502NDORDER.xlsx'

#FILE 503 DOCS
file503_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 5 stuff/FILE661/FILE6611STORDER.xlsx'
file503_root3peak='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 5 stuff/FILE661/FILE661ROOT3PEAK.xlsx'
file503_2ndorder='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 5 stuff/FILE661/FILE6612NDORDER.xlsx'


#FILE 496 PERPENDICULAR DOCS'C:/U
file496_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 5 stuff/FILE685/FILE6851STORDER.xlsx'
file496_root3peak='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 5 stuff/FILE685/FILE685ROOT3PEAK.xlsx'
file496_2ndorder='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 5 stuff/FILE685/FILE6852NDORDER.xlsx'
...
df4421storder = xl.parse('Sheet2'); df442root3 = x2.parse('Sheet2'); df4422ndorder = x3.parse('Sheet2')
...
df5051storder = x4.parse('Sheet2'); df505root3 = x5.parse('Sheet2'); df5052ndorder = x6.parse('Sheet2')
...
df4991storder = x7.parse('Sheet2'); df499root3 = x8.parse('Sheet2'); df4992ndorder = x9.parse('Sheet2')
...
df4721storder = x10.parse('Sheet2'); df472root3 = x11.parse('Sheet2'); df4722ndorder = x12.parse('Sheet2')
...
plt.plot(thickness505_array, areatotal505file_array, color='r', marker='None', ls='-',label='FILE 650')
plt.plot(thickness499_array, areatotal499file_array, color='b', marker='None', ls='-',label='FILE 661')
plt.plot(thickness442_array, areatotal442file_array, color='g', marker='None', ls='-',label='FILE 639')
plt.plot(thickness472_array, areatotal472file_array, color='y', marker='None', ls='-',label='FILE 685')
...
ax1.set_ylabel('Total azimuthal integrated intensity')
ax1.set_xlabel('Frame')
ax1.set_title('0.47 mm thickness, 12 mm form injection point')
#ax1.grid()
...
ax2.set_title('0.47 mm thickness, 12 mm from injection point')
ax2.set_xlabel('Frame')
ax2.set_ylabel('Total Azimuthal Integrated Intensity')
...
ax3.set_ylabel('Total azimuthal integrated intensity')
ax3.set_xlabel('Frame')
ax3.set_title('0.44 mm thickness, 27 mm from injection point')
#ax3.grid()
...
ax4.set_title('0.44 mm thickness, 27 mm from injection point')
ax4.set_xlabel('Frame')
ax4.set_ylabel('Total Azimuthal Integrated Intensity')
...
#ax5.grid()
ax5.set_title('0.41 mm thickness, 42 mm from injection point')
...
ax6.set_title('0.41 mm thickness, 42 mm from injection point')
...
ax7.set_title('0.43 mm thickness, perpendicular cut of sample')
#ax7.grid()
...
ax8.set_title('0.43 mm thickness, perpendicular cut of sample')
