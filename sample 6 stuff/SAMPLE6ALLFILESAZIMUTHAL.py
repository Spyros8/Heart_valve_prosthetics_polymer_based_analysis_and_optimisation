...
file462_root3peak='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 6 stuff/FILE642/FILE642ROOT3PEAK.xlsx'
file462_2ndorder='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 6 stuff/FILE642/FILE6422NDORDER.xlsx'

#FILE 510 DOCS
file510_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 6 stuff/FILE654/FILE6541STORDER.xlsx'
file510_root3peak='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 6 stuff/FILE654/FILE654ROOT3PEAK.xlsx'
file510_2ndorder='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 6 stuff/FILE654/FILE6542NDORDER.xlsx'

#FILE 503 DOCS
file503_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 6 stuff/FILE666/FILE6661STORDER.xlsx'
file503_root3peak='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 6 stuff/FILE666/FILE666ROOT3PEAK.xlsx'
file503_2ndorder='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 6 stuff/FILE666/FILE6662NDORDER.xlsx'
...
file496_root3peak='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 6 stuff/FILE689/FILE689ROOT3PEAK.xlsx'
file496_2ndorder='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/sample 6 stuff/FILE689/FILE6892NDORDER.xlsx'
...
df4421storder = xl.parse('Sheet2'); df442root3 = x2.parse('Sheet1'); df4422ndorder = x3.parse('Sheet1')
...
df5051storder = x4.parse('Sheet2'); df505root3 = x5.parse('Sheet1'); df5052ndorder = x6.parse('Sheet1')
...
df4991storder = x7.parse('Sheet2'); df499root3 = x8.parse('Sheet1'); df4992ndorder = x9.parse('Sheet1')
...
df4721storder = x10.parse('Sheet2'); df472root3 = x11.parse('Sheet1'); df4722ndorder = x12.parse('Sheet1')
...
plt.plot(thickness505_array, areatotal505file_array, color='r', marker='None', ls='-',label='FILE 654')
plt.plot(thickness499_array, areatotal499file_array, color='b', marker='None', ls='-',label='FILE 666')
plt.plot(thickness442_array, areatotal442file_array, color='g', marker='None', ls='-',label='FILE 642')
plt.plot(thickness472_array, areatotal472file_array, color='y', marker='None', ls='-',label='FILE 689')
...
ax3.set_ylabel('Total azimuthal integrated intensity')
ax3.set_xlabel('Frame')
ax3.set_title('0.7 mm thickness, 27 mm from injection point')
#ax3.grid()
...
ax4.set_title('0.7 mm thickness, 27 mm from injection point')
ax4.set_xlabel('Frame')
ax4.set_ylabel('Total Azimuthal Integrated Intensity')
...
#ax5.grid()
ax5.set_title('0.63 mm thickness, 42 mm from injection point')
...
ax6.set_title('0.63 mm thickness, 42 mm from injection point')
...
ax7.set_title('0.65 mm thickness, perpendicular cut of sample')
#ax7.grid()
...
ax8.set_title('0.65 mm thickness, perpendicular cut of sample')
