...
file='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/SAMPLE2/EXTRUSION/667individual.xlsx'
...
dfsr3= (df2skinroot3.iloc[675:735,:] - 150)
dfsr3[dfsr3 < 0] = 0
(df2skinroot3.iloc[675:735,:] - 150).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for skin at 180 degrees ' )
plt.show()
...
dfcr3= (df2coreroot3.iloc[180:450,:] - 50)
dfcr3[dfcr3 < 0] = 0
(df2coreroot3.iloc[180:480,:] - 0).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for core ' )
plt.show()
...
dfcr32 = dfcr3clean.iloc[900:1100, :]
...
for i in range(1, g+1):
    ...
    x_data, o_data[i] = (dfcoreroot3['DEG'].loc[180:449], dfcr3[i])
    #xdata =x_data/max(x_data)
    #ydata[i] =y_data[i]/max(y_data[i])
