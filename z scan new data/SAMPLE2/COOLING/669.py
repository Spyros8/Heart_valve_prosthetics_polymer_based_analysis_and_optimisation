...
file='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/SAMPLE2/COOLING/669individual.xlsx'
...
dfsr3= (df2skinroot3.iloc[640:755,:] - 100)
dfsr3[dfsr3 < 0] = 0
(df2skinroot3.iloc[640:755,:] - 100).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for skin at 180 degrees ' )
plt.show()
...
for i in range(1, d+1):
    ...
    x_data, u_data[i] = (dfskinroot3['DEG'].loc[640:754], dfsr3[i])
...
dfcr3= (df2coreroot3.iloc[150:500,:] - 20)
dfcr3[dfcr3 < 0] = 0
(df2coreroot3.iloc[150:500,:] - 20).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for core ' )
plt.show()



#all core root 3
dfcr3clean = (df2coreroot3 - 20)
