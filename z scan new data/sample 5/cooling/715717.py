...
file='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/sample 5/cooling/715717indi.xlsx'
...
dfsr3= (df2skinroot3.iloc[530:880,:] - 60)
dfsr3[dfsr3 < 0] = 0
(df2skinroot3.iloc[530:880,:] - 60).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for skin at 180 degrees ' )
plt.show()
...
for i in range(1, d+1):
    ...
    x_data, u_data[i] = (dfskinroot3['DEG'].loc[530:879], dfsr3[i])
...
dfcr3= (df2coreroot3.iloc[150:550,:] - 0)
dfcr3[dfcr3 < 0] = 0
(df2coreroot3.iloc[150:550,:] - 00).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for core ' )
plt.show()
...
dfcr32 = dfcr3clean.iloc[940:1200, :]
...
for i in range(1, g+1):
    ...
    x_data, o_data[i] = (dfcoreroot3['DEG'].loc[150:549], dfcr3[i])
    #xdata =x_data/max(x_data)
    #ydata[i] =y_data[i]/max(y_data[i])
