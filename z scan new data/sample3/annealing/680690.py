...
file='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/sample3/annealing/680690ind.xlsx'
...
dfsr3= (df2skinroot3.iloc[580:820,:] - 100)
dfsr3[dfsr3 < 0] = 0
(df2skinroot3.iloc[580:820,:] - 100).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for skin at 180 degrees ' )
plt.show()
...
for i in range(1, d+1):
    ...
    x_data, u_data[i] = (dfskinroot3['DEG'].loc[580:819], dfsr3[i])
...
dfcr3= (df2coreroot3.iloc[150:500,:] - 100)
dfcr3[dfcr3 < 0] = 0
(df2coreroot3.iloc[150:500,:] - 100).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for core ' )
plt.show()
...
dfcr32 = dfcr3clean.iloc[900:1200, :]
...
for i in range(1, g+1):
    ...
    x_data, o_data[i] = (dfcoreroot3['DEG'].loc[150:499], dfcr3[i])
    #xdata =x_data/max(x_data)
    #ydata[i] =y_data[i]/max(y_data[i])
...
dfc1[dfc1 < 0]=0
dfc1.iloc[150:540,:].plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = '1st order peaks for core ' )
plt.show()
...
for i in range(1, h+1):
    ...
    x_data, v_data[i] = (dfcore1['DEG'].loc[150:539], dfcr1[i])
    #xdata =x_data/max(x_data)
    #ydata[i] =y_data[i]/max(y_data[i])
