...
file='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/sample3/cooling/692694indi.xlsx'
...
dfsr3= (df2skinroot3.iloc[580:820,:] - 150)
dfsr3[dfsr3 < 0] = 0
(df2skinroot3.iloc[580:820,:] - 200).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for skin at 180 degrees ' )
plt.show()
...
dfcr32 = dfcr3clean.iloc[860:1200, :]
