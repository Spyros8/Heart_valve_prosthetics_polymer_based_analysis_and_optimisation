...
file='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/sample 7/file742individual.xlsx'
...
plt.title('FILE 742 - sample 7 of thickness 0.55-0.73 mm')
plt.xlabel('Frame')
...
plt.plot(frame_array442, file442ratio1, 'r.', color='g', marker='.',label='FILE 742 - sample 7 of thickness 0.55-0.73 mm')
...
(ax1, ax2) = axs
fig10.suptitle('FILE 742 - sample 7 of thickness 0.55-0.73 mm')
...
dfsr3= (df2skinroot3.iloc[530:840,:] - 100)
dfsr3[dfsr3 < 0] = 0
(df2skinroot3.iloc[530:840,:] - 100).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for skin at 180 degrees ' )
plt.show()
...
for i in range(1, d+1):
    ...
    x_data, u_data[i] = (dfskinroot3['DEG'].loc[530:839], dfsr3[i])
    #xdata =x_data/max(x_data)
    #ydata[i] =y_data[i]/max(y_data[i])
...
plt.ylabel('Intensity for Fit')
plt.xlabel('azimuthal angle')
plt.title('Polynomial fit of order 120 to root 3 skin at 180 degrees for sample 7')
plt.show()
...
plt.ylabel('Intensity for Fit')
plt.xlabel('azimuthal angle')
plt.title('Polynomial fit for root 3 skin peaks of sample 7')
plt.show()
...
dfs1[dfs1 < 0]=0
dfs1.iloc[520:890,:].plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = '1st order peaks for skin ' )
plt.show()
...
plt.ylabel('Intensity for Fit')
plt.xlabel('azimuthal angle')
plt.title('Polynomial fit for 1st order skin peaks of sample 7')
plt.show()
...
for i in range(1, e+1):
    ...
    x_data, n_data[i] = (dfskin1['DEG'].loc[520:889], dfsr1[i])
    #xdata =x_data/max(x_data)
    #ydata[i] =y_data[i]/max(y_data[i])
...
plt.ylabel('Intensity for Fit')
plt.title('Polynomial fit for 1st order skin at 180 degrees of sample 7')
plt.xlabel('azimuthal angle')
plt.show()
...
dfcr3= (df2coreroot3.iloc[300:550,:] - 90)
dfcr3[dfcr3 < 0] = 0
(df2coreroot3.iloc[300:550,:] - 90).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for core ' )
plt.show()



#all core root 3
dfcr3clean = (df2coreroot3 - 90)
dfcr3clean[dfcr3clean < 0]=0
dfcr3clean.plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for core overall ' )
plt.show()

dfcr32 = dfcr3clean.iloc[920:1230, :]
...
for i in range(1, g+1):
    ...
    x_data, o_data[i] = (dfcoreroot3['DEG'].loc[300:549], dfcr3[i])
    #xdata =x_data/max(x_data)
    #ydata[i] =y_data[i]/max(y_data[i])
...
plt.ylabel('Intensity for Fit')
plt.title('Polynomial fit for root 3 core peaks at 90 degrees of sample 7')
plt.xlabel('azimuthal angle')
plt.show()
...
plt.ylabel('Intensity for Fit')
plt.title('Polynomial fit for root 3 peaks of sample 7')
plt.xlabel('azimuthal angle')
plt.show()
...
dfc1 = (df2core1-150)
dfc1[dfc1 < 0]=0
dfcr1 = dfc1.iloc[170:530, :]

#core1st order 270 deg
dfcr12 = dfc1.iloc[870:1230, :]
...
dfc1[dfc1 < 0]=0
dfc1.iloc[170:530,:].plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = '1st order peaks for core ' )
plt.show()
...
plt.ylabel('Intensity for Fit')
plt.title('Polynomial fit for 1st order core peaks of sample 7')
plt.xlabel('azimuthal angle')
plt.show()
...
for i in range(1, h+1):
    ...
    x_data, v_data[i] = (dfcore1['DEG'].loc[170:529], dfcr1[i])
    #xdata =x_data/max(x_data)
    #ydata[i] =y_data[i]/max(y_data[i])
...
plt.ylabel('Intensity for Fit')
plt.title('Polynomial fit for 1st order core peaks at 90 degrees of sample 7')
plt.xlabel('azimuthal angle')
plt.show()
...
ax1.set_xlabel('Frame')
plt.grid()
ax1.set_title('FILE 742 - sample 7 of thickness 0.55-0.73 mm clean data')
plt.show()
...
plt.figure(figsize = (12,8))
plt.title('1st order core FWHM for sample 7 extrusion and annealing')
...
plt.figure(figsize = (12,8))
plt.title('root 3 core FWHM for sample 7 extrusion and annealing')
...
plt.figure( figsize = (12, 8))
plt.title('1st order skin FWHM for sample 7 extrusion and annealing')
...
plt.figure(figsize = (12, 8))
plt.title('root 3 skin FWHM for sample 7 extrusion and annealing')
