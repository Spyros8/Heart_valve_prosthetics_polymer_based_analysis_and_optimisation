#0.8-0.83 mm thickness & annealing 30 min
# Import pandas
...
#FILE 442 DOCS
file442_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/SAMPLE 11/file783raw.xlsx'
file='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/SAMPLE 11/file783extrallindiv.xlsx'
...
l1 =  ax1.scatter(frame_array442, areatrap4421storder_array, marker=".", label='1st order peaks')
l2 =  ax1.scatter(frame_array442, areatrap442root3_array, marker=".", label= 'root 3 order peaks')
...
plt.grid()
ax1.set_title('FILE 783 - sample 11 of thickness 1.46-1.51 mm')
plt.show()
...
plt.plot(frame_array442, areatrap442root3_array, 'r.', marker='.', label='root 3 peaks')
#plt.xticks(np.arange(0, 100, 5))
plt.title('FILE 783 - sample 11 of thickness 1.46-1.51 mm')
plt.xlabel('Frame')
...
plt.plot(frame_array442, file442ratio1, 'r.', color='g', marker='.',label='FILE 783 - sample 11 of thickness 1.46-1.51 mm')
...
ax1.set_xlabel('Frame')
plt.grid()
ax1.set_title('FILE 742 - sample 7 of thickness 0.55-0.73 mm')
plt.show()
...
ratioskincore1 = np.divide(areacore1, areacoreroot3)
ratioskincoreroot3 = np.divide(areaskin1, areaskinroot3)


fig10, axs = plt.subplots(nrows = 1, ncols = 2, constrained_layout = True, figsize=(20,10))
(ax1, ax2) = axs
fig10.suptitle('FILE 783 - sample 11 of thickness 1.46-1.51 mm')

ax1.plot(frame_array442, ratioskincore1, 'b.', color='b', marker='.', label='skin/core root 3')
ax1.set_title('Ratio 1st order/root 3 core')
ax1.set_xlabel('Frame')
ax1.set_ylabel('Total Azimuthal Integrated Intensity ratio')
#ax2.legend(loc = 'upper right')
ax1.grid()

ax2.plot(frame_array442, ratioskincoreroot3, 'r.', color='r', marker='.', label='skin/core 1st order')
ax2.set_title('Ratio 1st order root3 skin')
...
dfsr3= (df2skinroot3.iloc[520:870,:] - 110)
dfsr3[dfsr3 < 0] = 0
(df2skinroot3.iloc[520:870,:] - 110).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for skin at 180 degrees ' )
plt.show()
...
for i in range(1, d+1):
    ...
    x_data, u_data[i] = (dfskinroot3['DEG'].loc[520:869], dfsr3[i])
    #xdata =x_data/max(x_data)
    #ydata[i] =y_data[i]/max(y_data[i])
...
plt.ylabel('Intensity for Fit')
plt.xlabel('azimuthal angle')
plt.title('Polynomial fit of order 120 to root 3 skin at 180 degrees for sample 11')
plt.show()
...
plt.ylabel('Intensity for Fit')
plt.xlabel('azimuthal angle')
plt.title('Polynomial fit for root 3 skin peaks of sample 11')
plt.show()


#skin 1st order
#dfs1.index.rename('Azimuthal angle', inplace = True)
dfs1 = (df2skin1-200)
dfs1[dfs1 < 0]=0
dfsr1 = dfs1.iloc[525:885, :]


dfs1.iloc[:, :].plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = '1st order peaks for skin ' )
plt.show()

dfs1[dfs1 < 0]=0
dfs1.iloc[525:885,:].plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = '1st order peaks for skin ' )
plt.show()

dfsr12 = dfs1.iloc[0:100,:]
dfsr12.plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = '1st order peaks for skin at 0 degrees ' )

dfsr13 = dfs1.iloc[1300:1400,:]
...
plt.ylabel('Intensity for Fit')
plt.xlabel('azimuthal angle')
plt.title('Polynomial fit for 1st order skin peaks of sample 11')
plt.show()
...
for i in range(1, e+1):
    ...
    x_data, n_data[i] = (dfskin1['DEG'].loc[525:884], dfsr1[i])
    #xdata =x_data/max(x_data)
    #ydata[i] =y_data[i]/max(y_data[i])
...
plt.ylabel('Intensity for Fit')
plt.title('Polynomial fit for 1st order skin at 180 degrees of sample 11')
plt.xlabel('azimuthal angle')
plt.show()
...
#for core
df2coreroot3.index.rename('Azimuthal angle', inplace = True)
dfcr3= (df2coreroot3.iloc[155:580,:] - 100)
dfcr3[dfcr3 < 0] = 0
(df2coreroot3.iloc[155:580,:] - 100).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for core ' )
plt.show()



#all core root 3
dfcr3clean = (df2coreroot3 - 100)
dfcr3clean[dfcr3clean < 0]=0
dfcr3clean.plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for core overall ' )
plt.show()

dfcr32 = dfcr3clean.iloc[920:1222, :]
...
for i in range(1, g+1):
    ...
    x_data, o_data[i] = (dfcoreroot3['DEG'].loc[155:579], dfcr3[i])
    #xdata =x_data/max(x_data)
    #ydata[i] =y_data[i]/max(y_data[i])
...
plt.ylabel('Intensity for Fit')
plt.title('Polynomial fit for root 3 core peaks at 90 degrees of sample 11')
plt.xlabel('azimuthal angle')
plt.show()
...
plt.ylabel('Intensity for Fit')
plt.title('Polynomial fit for root 3 peaks of sample 11')
plt.xlabel('azimuthal angle')
plt.show()


#core 1st order
#dfc1.index.rename('Azimuthal angle', inplace = True)
dfc1 = (df2core1-200)
dfc1[dfc1 < 0]=0
dfcr1 = dfc1.iloc[173:527, :]

#core1st order 270 deg
dfcr12 = dfc1.iloc[870:1237, :]
...
dfc1[dfc1 < 0]=0
dfc1.iloc[173:527,:].plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = '1st order peaks for core ' )
plt.show()
...
plt.ylabel('Intensity for Fit')
plt.title('Polynomial fit for 1st order core peaks of sample 11')
plt.xlabel('azimuthal angle')
plt.show()
...
for i in range(1, h+1):
    ...
    x_data, v_data[i] = (dfcore1['DEG'].loc[173:526], dfcr1[i])
    #xdata =x_data/max(x_data)
    #ydata[i] =y_data[i]/max(y_data[i])
...
plt.ylabel('Intensity for Fit')
plt.title('Polynomial fit for 1st order core peaks at 90 degrees of sample 11')
plt.xlabel('azimuthal angle')
plt.show()
...
ax1.set_xlabel('Frame')
plt.grid()
ax1.set_title('FILE 783 - sample 11 of thickness 1.46-1.51 mm clean data')
plt.show()
...
for i in range(1, (x+1)):
    #print(i)
    f = i-1
    df_listcore1[i-1] = dfcr1.index[(dfcr1.iloc[:, i-1] <= 1.15*dfhalfmaxcore1[i]) & (0.85*dfhalfmaxcore1[i] <= dfcr1.iloc[:, i-1])]
...
core1maxanglesss[core1maxanglesss == core1maxanglesss[0]]=0
core1minanglesss = np.array(core1minangless)
core1minanglesss[core1minanglesss == core1minanglesss[0]]=0
print(core1minanglesss[0])
...
plt.figure(figsize = (12,8))
plt.title('1st order core FWHM for sample 11 extrusion and annealing')
...
core3maxanglesss[core3maxanglesss == core3maxanglesss[0]] = 0
core3minanglesss = np.array(core3minangless)
core3minanglesss[core3minanglesss == core3minanglesss[0]] = 0
print(core3minanglesss[0])   
print(core3maxanglesss[0])
FWHMcore3 = np.subtract(core3maxanglesss, core3minanglesss)
FWHMcore3 = np.where((FWHMcore3 > 30), nan, FWHMcore3)
...
plt.figure(figsize = (12,8))
plt.title('root 3 core FWHM for sample 11 extrusion and annealing')
...
skin1maxanglesss[skin1maxanglesss == skin1maxanglesss[0]]=0
skin1minanglesss = np.array(skin1minangless)    
skin1minanglesss[skin1minanglesss == skin1minanglesss[0]]=0
FWHMskin1 = np.subtract(skin1maxanglesss, skin1minanglesss) 
FWHMskin1 = np.where((FWHMskin1 > 60), nan, FWHMskin1)  
FWHMskin1 = np.where((FWHMskin1 < 0), nan, FWHMskin1) 
plt.figure(figsize = (12, 8))
...
plt.figure( figsize = (12, 8))
plt.title('1st order skin FWHM for sample 11 extrusion and annealing')
...
for i in range(1, (s+1)):
    #print(i)
    f = i-1
    df_listskin3[i-1] = dfsr3.index[(dfsr3.iloc[:, i-1] <= 1.17*dfhalfmaxskin3[i]) & (0.83*dfhalfmaxskin3[i] <= dfsr3.iloc[:, i-1])]
...
skin3maxanglesss[skin3maxanglesss == skin3maxanglesss[0]] = 0
skin3minanglesss = np.array(skin3minangless)
skin3minanglesss[skin3minanglesss == skin3minanglesss[0]] = 0
print(skin3minanglesss[4])
FWHMskin3 = np.subtract(skin3maxanglesss, skin3minanglesss) 
FWHMskin3 = np.where((FWHMskin3 < 0), nan, FWHMskin3)   
plt.figure(figsize = (12, 8))
...
plt.figure(figsize = (12, 8))
plt.title('root 3 skin FWHM for sample 11 extrusion and annealing')
