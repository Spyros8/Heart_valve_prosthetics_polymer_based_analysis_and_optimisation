...
file= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/samaple9/annealing/762771indi.xlsx'
...
dfsr3= (df2skinroot3.iloc[490:880,:] - 20)
dfsr3[dfsr3 < 0] = 0
(df2skinroot3.iloc[490:880,:] - 20).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for skin at 180 degrees ' )
plt.show()
...
dfcr3= (df2coreroot3.iloc[140:560,:] - 20)
dfcr3[dfcr3 < 0] = 0
(df2coreroot3.iloc[140:560,:] - 20).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for core ' )
plt.show()
