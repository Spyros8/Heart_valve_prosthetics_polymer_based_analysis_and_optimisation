...
#FILE 442 DOCS
file442_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/dspacinglastprocessing/sampel9/annealing/762771dsp.xlsx'
...
(df2c190.iloc[60:95,:]-50).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'core1 90 ' )
...
(df2s10.iloc[60:90,:]-50).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 0 ' )

(df2s1180.iloc[60:90,:]-50).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 180 ' )
...
skin10 = (df2s10.iloc[60:90,:]-50)
skin10[skin10 < 0] = 0
skin1180 = (df2s1180.iloc[60:90,:]-50)
