...
#FILE 442 DOCS
file442_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/dspacinglastprocessing/sample8/extrusion/749dsp.xlsx'
...
(df2c1270.iloc[60:95,:]-100).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'core1 270 ' )

(df2c190.iloc[60:95,:]-100).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'core1 90 ' )

(df2c3270.iloc[110:140,:]-50).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'coreroot3 270 ' )

(df2c390.iloc[110:135,:]-50).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'coreroot3 90' )


(df2s10.iloc[60:90,:]-100).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 0 ' )

(df2s1180.iloc[60:95,:]-100).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 180 ' )

(df2s3180.iloc[100:140,:]-70).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skinroot3 180 ' )

(df2s30.iloc[100:140,:]- 70).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skinroot3 0 ' )

core190 = (df2c190.iloc[60:95,:]-100)
core190[core190 < 0]=0
core1270 = (df2c1270.iloc[60:95,:]-100)
core1270[core1270 < 0]=0
core3270 = (df2c3270.iloc[110:140,:]-50)
core3270[core3270 < 0] = 0
core390 = (df2c390.iloc[110:135,:] - 50)
core390[core390 < 0] = 0

skin10 = (df2s10.iloc[60:90,:]-100)
skin10[skin10 < 0] = 0
skin1180 = (df2s1180.iloc[60:95,:]-100)
skin1180[skin1180 < 0]=0
skin3180 = (df2s3180.iloc[100:140,:]-70)
skin3180[skin3180<0]=0
skin30 = (df2s30.iloc[100:140,:]-70)
skin30[skin30<0]=0
