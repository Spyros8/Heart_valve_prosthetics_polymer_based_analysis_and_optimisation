...
#FILE 442 DOCS
file442_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/dspacinglastprocessing/sample8/cooling/750753dsp.xlsx'
...
(df2c1270.iloc[59:96,:]-160).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'core1 270 ' )

(df2c190.iloc[59:96,:]-100).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'core1 90 ' )

(df2c3270.iloc[109:140,:]-60).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'coreroot3 270 ' )

(df2c390.iloc[109:140,:]-60).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'coreroot3 90' )


(df2s10.iloc[59:95,:]-150).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 0 ' )

(df2s1180.iloc[59:95,:]-150).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 180 ' )

(df2s3180.iloc[113:137,:]-40).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skinroot3 180 ' )

(df2s30.iloc[114:136,:]- 40).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skinroot3 0 ' )

core190 = (df2c190.iloc[59:96,:]-100)
core190[core190 < 0]=0
core1270 = (df2c1270.iloc[59:96,:]-160)
core1270[core1270 < 0]=0
core3270 = (df2c3270.iloc[109:140,:]-60)
core3270[core3270 < 0] = 0
core390 = (df2c390.iloc[109:140,:] - 60)
core390[core390 < 0] = 0

skin10 = (df2s10.iloc[59:95,:]-150)
skin10[skin10 < 0] = 0
skin1180 = (df2s1180.iloc[59:95,:]-150)
skin1180[skin1180 < 0]=0
skin3180 = (df2s3180.iloc[113:137,:]-40)
skin3180[skin3180<0]=0
skin30 = (df2s30.iloc[114:136,:]-40)
skin30[skin30<0]=0
