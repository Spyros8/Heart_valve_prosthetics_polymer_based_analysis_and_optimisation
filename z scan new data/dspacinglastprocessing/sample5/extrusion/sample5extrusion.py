...
#FILE 442 DOCS
file442_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/dspacinglastprocessing/sample5/extrusion/711713dsp.xlsx'
...
(df2c1270.iloc[60:95,:]-60).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'core1 270 ' )

(df2c190.iloc[65:95,:]-60).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'core1 90 ' )
...
core190 = (df2c190.iloc[65:95,:]-60)
core190[core190 < 0]=0
core1270 = (df2c1270.iloc[60:95,:]-60)
