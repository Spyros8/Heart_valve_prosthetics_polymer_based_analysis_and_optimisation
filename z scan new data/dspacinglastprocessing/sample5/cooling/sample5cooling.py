...
#FILE 442 DOCS
file442_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/dspacinglastprocessing/sample5/cooling/715717dsp.xlsx'
...
(df2c1270.iloc[62:95,:]-60).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'core1 270 ' )
