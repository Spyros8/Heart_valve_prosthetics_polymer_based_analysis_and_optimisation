...
#FILE 442 DOCS
file442_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/dspacinglastprocessing/sample3/extrusiion/677678.xlsx'
...
(df2c190.iloc[60:95,:]-150).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'core1 90 ' )
...
(df2s1180.iloc[62:85,:]-170).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 180 ' )
...
core190 = (df2c190.iloc[60:95,:]-150)
core190[core190 < 0]=0
...
skin10[skin10 < 0] = 0
skin1180 = (df2s1180.iloc[62:85,:]-160)
