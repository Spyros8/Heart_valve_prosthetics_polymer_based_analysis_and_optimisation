...
#FILE 442 DOCS
file442_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/dspacinglastprocessing/sample3/cooling/692694dsp.xlsx'
...
dfs1180 = x1.parse('skin1180'); dfs30 = x1.parse('skinroot30'); dfs3180 = x1.parse('skinroot3180')
...
(df2c1270.iloc[60:95,:]-150).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'core1 270 ' )

(df2c190.iloc[60:90,:]-150).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'core1 90 ' )

(df2c3270.iloc[105:145,:]-50).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'coreroot3 270 ' )

(df2c390.iloc[105:145,:]-50).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'coreroot3 90' )


#(df2s10.iloc[62:85,:]-170).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 0 ' )

(df2s1180.iloc[67:80,:]-170).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 180 ' )

(df2s3180.iloc[115:137,:]-50).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skinroot3 180 ' )

(df2s30.iloc[115:137,:]- 50).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skinroot3 0 ' )

core190 = (df2c190.iloc[60:90,:]-150)
core190[core190 < 0]=0
core1270 = (df2c1270.iloc[60:95,:]-150)
core1270[core1270 < 0]=0
core3270 = (df2c3270.iloc[105:145,:]-50)
core3270[core3270 < 0] = 0
core390 = (df2c390.iloc[105:145,:] - 50)
core390[core390 < 0] = 0

#skin10 = (df2s10.iloc[62:85,:]-170)
#skin10[skin10 < 0] = 0
skin1180 = (df2s1180.iloc[67:80,:]-160)
skin1180[skin1180 < 0]=0
skin3180 = (df2s3180.iloc[115:137,:]-50)
skin3180[skin3180<0]=0
skin30 = (df2s30.iloc[115:137,:]-50)
skin30[skin30<0]=0
...
y = np.arange(1,(len(dfskin1180dsp) + 1),1)
