...
#FILE 442 DOCS
file442_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/dspacinglastprocessing/sample6/extrusion/723724dsp.xlsx'
...
(df2c1270.iloc[60:95,:]-50).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'core1 270 ' )

(df2c190.iloc[62:95,:]-60).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'core1 90 ' )

(df2c3270.iloc[105:145,:]-0).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'coreroot3 270 ' )

(df2c390.iloc[105:145,:]-0).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'coreroot3 90' )


(df2s10.iloc[62:85,:]-50).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 0 ' )

(df2s1180.iloc[62:85,:]-50).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 180 ' )
...
core190 = (df2c190.iloc[62:95,:]-60)
core190[core190 < 0]=0
core1270 = (df2c1270.iloc[62:95,:]-60)
core1270[core1270 < 0]=0
core3270 = (df2c3270.iloc[105:145,:]-0)
core3270[core3270 < 0] = 0
core390 = (df2c390.iloc[105:145,:] - 0)
core390[core390 < 0] = 0

skin10 = (df2s10.iloc[62:85,:]-50)
skin10[skin10 < 0] = 0
skin1180 = (df2s1180.iloc[62:85,:]-50)
