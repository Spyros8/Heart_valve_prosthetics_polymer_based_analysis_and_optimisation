...
#FILE 442 DOCS
file442_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/dspacinglastprocessing/sample6/annealing/726735dsp.xlsx'
...
(df2s10.iloc[62:90,:]-50).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 0 ' )

(df2s1180.iloc[62:90,:]-50).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 180 ' )
...
skin10 = (df2s10.iloc[62:90,:]-50)
skin10[skin10 < 0] = 0
skin1180 = (df2s1180.iloc[62:90,:]-50)
