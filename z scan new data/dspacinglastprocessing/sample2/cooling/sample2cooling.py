...
#FILE 442 DOCS
file442_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/dspacinglastprocessing/sample2/cooling/669671.xlsx'
...
(df2c3270.iloc[110:145,:]-50).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'coreroot3 270 ' )

(df2c390.iloc[110:145,:]-50).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'coreroot3 90' )


(df2s10.iloc[62:85,:]-160).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 0 ' )

(df2s1180.iloc[62:85,:]-160).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 180 ' )
...
core3270 = (df2c3270.iloc[110:145,:]-50)
core3270[core3270 < 0] = 0
core390 = (df2c390.iloc[110:145,:] - 50)
core390[core390 < 0] = 0

skin10 = (df2s10.iloc[62:85,:]-160)
skin10[skin10 < 0] = 0
