...
#FILE 442 DOCS
file442_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/sample 4/file 707.xlsx'
file='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/sample 4/fileforratios.xlsx'
...
plt.grid()
ax1.set_title('FILE 707 - sample 4 of thickness 0.8-0.83 mm')
plt.show()
...
plt.title('FILE 707 - sample 4 of thickness 0.8-0.83 mm')
plt.xlabel('Frame')
...
plt.plot(frame_array442, file442ratio1, 'r.', color='g', marker='.',label='FILE 707 - sample 4 of thickness 0.8-0.83 mm')
...
(ax1, ax2) = axs
fig10.suptitle('FILE 707 - sample 4 of thickness 0.8-0.83 mm')
...
dfsr3= (df2skinroot3.iloc[640:750,:] - 200)
dfsr3[dfsr3 < 0] = 0
(df2skinroot3.iloc[640:750,:] - 200).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for skin at 180 degrees ' )
plt.show()
...
for i in range(1, d+1):
    ...
    x_data, u_data[i] = (dfskinroot3['DEG'].loc[640:749], dfsr3[i])
    #xdata =x_data/max(x_data)
    #ydata[i] =y_data[i]/max(y_data[i])
...
plt.ylabel('Intensity for Fit')
plt.xlabel('azimuthal angle')
plt.title('Polynomial fit of order 120 to root 3 skin at 180 degrees for sample 4')
plt.show()
...
plt.ylabel('Intensity for Fit')
plt.xlabel('azimuthal angle')
plt.title('Polynomial fit for root 3 skin peaks of sample 4')
plt.show()
...
dfs1[dfs1 < 0]=0
dfs1.iloc[570:800,:].plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = '1st order peaks for skin ' )
plt.show()
...
plt.ylabel('Intensity for Fit')
plt.xlabel('azimuthal angle')
plt.title('Polynomial fit for 1st order skin peaks of sample 4')
plt.show()
...
for i in range(1, e+1):
    ...
    x_data, n_data[i] = (dfskin1['DEG'].loc[570:799], dfsr1[i])
    #xdata =x_data/max(x_data)
    #ydata[i] =y_data[i]/max(y_data[i])
...
plt.ylabel('Intensity for Fit')
plt.title('Polynomial fit for 1st order skin at 180 degrees of sample 4')
plt.xlabel('azimuthal angle')
plt.show()
...
dfcr3= (df2coreroot3.iloc[290:440,:] - 105)
dfcr3[dfcr3 < 0] = 0
(df2coreroot3.iloc[290:440,:] - 105).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for core ' )
plt.show()



#all core root 3
dfcr3clean = (df2coreroot3 - 105)
dfcr3clean[dfcr3clean < 0]=0
dfcr3clean.plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for core overall ' )
plt.show()

dfcr32 = dfcr3clean.iloc[1000:1150, :]
...
for i in range(1, g+1):
    ...
    x_data, o_data[i] = (dfcoreroot3['DEG'].loc[290:439], dfcr3[i])
    #xdata =x_data/max(x_data)
    #ydata[i] =y_data[i]/max(y_data[i])
...
plt.ylabel('Intensity for Fit')
plt.title('Polynomial fit for root 3 core peaks at 90 degrees of sample 4')
plt.xlabel('azimuthal angle')
plt.show()
...
plt.ylabel('Intensity for Fit')
plt.title('Polynomial fit for root 3 peaks of sample 4')
plt.xlabel('azimuthal angle')
plt.show()
...
dfc1 = (df2core1-380)
dfc1[dfc1 < 0]=0
dfcr1 = dfc1.iloc[200:450, :]
dfc1[dfc1>550]=550

#core1st order 270 deg
dfcr12 = dfc1.iloc[950:1150, :]
...
dfc1[dfc1 < 0]=0
dfc1.iloc[200:450,:].plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = '1st order peaks for core ' )
plt.show()
...
plt.ylabel('Intensity for Fit')
plt.title('Polynomial fit for 1st order core peaks of sample 4')
plt.xlabel('azimuthal angle')
plt.show()
...
for i in range(1, h+1):
    ...
    x_data, v_data[i] = (dfcore1['DEG'].loc[200:449], dfcr1[i])
    #xdata =x_data/max(x_data)
    #ydata[i] =y_data[i]/max(y_data[i])
...
plt.ylabel('Intensity for Fit')
plt.title('Polynomial fit for 1st order core peaks at 90 degrees of sample 4')
plt.xlabel('azimuthal angle')
plt.show()
...
ax1.set_xlabel('Frame')
plt.grid()
ax1.set_title('FILE 707 - sample 4 of thickness 0.8-0.83 mm clean data')
plt.show()
...
plt.figure(figsize = (12,8))
plt.title('1st order core FWHM for sample 4 extrusion and annealing')
...
for i in range(1, (l+1)):
    #print(i)
    f = i-1
    df_listcore3[i-1] = dfcr3.index[(dfcr3.iloc[:, i-1] <= 1.15*dfhalfmaxcore3[i]) & (0.85*dfhalfmaxcore3[i] <= dfcr3.iloc[:, i-1])]
...
FWHMcore3 = np.where((FWHMcore3 > 15), nan, FWHMcore3)
...
plt.figure(figsize = (12,8))
plt.title('root 3 core FWHM for sample 4 extrusion and annealing')
...
for i in range(1, (r+1)):
    #print(i)
    f = i-1
    df_listskin1[i-1] = dfsr1.index[(dfsr1.iloc[:, i-1] <= 1.15*dfhalfmaxskin1[i]) & (0.85*dfhalfmaxskin1[i] <= dfsr1.iloc[:, i-1])]
...
FWHMskin1 = np.where((FWHMskin1 > 29), nan, FWHMskin1)   
plt.figure(figsize = (12, 8))
...
plt.figure( figsize = (12, 8))
plt.title('1st order skin FWHM for sample 4 extrusion and annealing')
...
for i in range(1, (s+1)):
    #print(i)
    f = i-1
    df_listskin3[i-1] = dfsr3.index[(dfsr3.iloc[:, i-1] <= 1.15*dfhalfmaxskin3[i]) & (0.85*dfhalfmaxskin3[i] <= dfsr3.iloc[:, i-1])]
...
plt.figure(figsize = (12, 8))
plt.title('root 3 skin FWHM for sample 4 extrusion and annealing')
