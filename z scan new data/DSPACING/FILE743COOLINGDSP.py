...
#FILE 442 DOCS
file442_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/DSPACING/DSPACING743.xlsx'
...
(df2c1270.iloc[60:80,:]-300).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'core1 270 ' )

(df2c190.iloc[60:80,:]-300).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'core1 90 ' )

(df2c3270.iloc[111:129,:]-60).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'coreroot3 270 ' )

(df2c390.iloc[113:129,:]-60).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'coreroot3 90' )


(df2s10.iloc[64:90,:]-130).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 0 ' )

(df2s1180.iloc[64:90,:]-130).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 180 ' )

(df2s3180.iloc[120:140,:]-20).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skinroot3 180 ' )

(df2s30.iloc[120:140,:]- 20).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skinroot3 0 ' )

core190 = (df2c190.iloc[60:80,:]-300)
core190[core190 < 0]=0
core1270 = (df2c1270.iloc[60:80,:]-300)
core1270[core1270 < 0]=0
core3270 = (df2c3270.iloc[111:129,:]-60)
core3270[core3270 < 0] = 0
core390 = (df2c390.iloc[113:129,:] - 60)
core390[core390 < 0] = 0

skin10 = (df2s10.iloc[64:90,:]-110)
skin10[skin10 < 0] = 0
skin1180 = (df2s1180.iloc[64:90,:]-110)
skin1180[skin1180 < 0]=0
skin3180 = (df2s3180.iloc[120:140,:]-20)
skin3180[skin3180<0]=0
skin30 = (df2s30.iloc[120:140,:]-20)
skin30[skin30<0]=0
