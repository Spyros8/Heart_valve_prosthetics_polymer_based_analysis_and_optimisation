...
#FILE 442 DOCS
file442_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/DSPACING/DSPACING780.xlsx'
...
(df2c1270.iloc[60:80,:]-200).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'core1 270 ' )

(df2c190.iloc[60:80,:]-200).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'core1 90 ' )

(df2c3270.iloc[115:135,:]-00).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'coreroot3 270 ' )

(df2c390.iloc[115:135,:]-00).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'coreroot3 90' )


(df2s10.iloc[69:85,:]-100).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 0 ' )

(df2s1180.iloc[69:88,:]-100).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 180 ' )

(df2s3180.iloc[120:140,:]-0).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skinroot3 180 ' )

(df2s30.iloc[120:140,:]- 00).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skinroot3 0 ' )

core190 = (df2c190.iloc[60:80,:]-200)
core190[core190 < 0]=0
core1270 = (df2c1270.iloc[60:80,:]-200)
core1270[core1270 < 0]=0
core3270 = (df2c3270.iloc[115:135,:])
core3270[core3270 < 0] = 0
core390 = (df2c390.iloc[115:135,:])
core390[core390 < 0] = 0

skin10 = (df2s10.iloc[69:85,:]-100)
skin10[skin10 < 0] = 0
skin1180 = (df2s1180.iloc[69:88,:]-100)
skin1180[skin1180 < 0]=0
skin3180 = (df2s3180.iloc[120:140,:]-0)
skin3180[skin3180<0]=0
skin30 = (df2s30.iloc[120:140,:]-0)
skin30[skin30<0]=0
...
fig1.suptitle('D spacing per frame for core 1st order sample 10 cooling')
...
#core 1st order at different angular positions
fig1, ax1 = plt.subplots(nrows = 1, ncols = 1, constrained_layout = True, figsize=(12,8))
fig1.suptitle('D spacing per frame for core root 3 sample 10 cooling')
...
#core 1st order at different angular positions
fig1, ax1 = plt.subplots(nrows = 1, ncols = 1, constrained_layout = True, figsize=(12,8))
fig1.suptitle('D spacing per frame for skin 1st order sample 10 cooling')
...
#core 1st order at different angular positions
fig1, ax1 = plt.subplots(nrows = 1, ncols = 1, constrained_layout = True, figsize=(12,8))
fig1.suptitle('D spacing per frame for skin root 3 sample 10 cooling')
