...
#FILE 442 DOCS
file442_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/DSPACING/DSPACING742.xlsx'
...
(df2c1270.iloc[58:95,:]-230).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'core1 270 ' )

(df2c190.iloc[58:95,:]-230).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'core1 90 ' )

(df2c3270.iloc[118:130,:]-220).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'coreroot3 270 ' )

(df2c390.iloc[118:132,:]-220).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'coreroot3 90' )


(df2s10.iloc[58:95,:]-220).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 0 ' )

(df2s1180.iloc[62:100,:]-230).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skin1 180 ' )

(df2s3180.iloc[115:135,:]-206).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skinroot3 180 ' )

(df2s30.iloc[115:135,:]- 206).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'skinroot3 0 ' )

core190 = (df2c190.iloc[58:95,:]-230)
core190[core190 < 0]=0
core1270 = (df2c1270.iloc[58:95,:]-230)
core1270[core1270 < 0]=0
core3270 = (df2c3270.iloc[118:130,:] - 220)
core3270[core3270 < 0] = 0
core390 = (df2c390.iloc[118:132,:] - 220)
core390[core390 < 0] = 0

skin10 = (df2s10.iloc[58:95,:]-220)
skin10[skin10 < 0] = 0
skin1180 = (df2s1180.iloc[62:100,:]-230)
skin1180[skin1180 < 0]=0
skin3180 = (df2s3180.iloc[115:135,:]-205)
skin3180[skin3180<0]=0
skin30 = (df2s30.iloc[115:135,:]-205)
skin30[skin30<0]=0
...
fig1.suptitle('D spacing per frame for core 1st order sample 7 extrusion and annealing')
...
#core 1st order at different angular positions
fig1, ax1 = plt.subplots(nrows = 1, ncols = 1, constrained_layout = True, figsize=(12,8))
fig1.suptitle('D spacing per frame for core root 3 sample 7 extrusion and annealing')
...
#core 1st order at different angular positions
fig1, ax1 = plt.subplots(nrows = 1, ncols = 1, constrained_layout = True, figsize=(12,8))
fig1.suptitle('D spacing per frame for skin 1st order sample 7 extrusion and annealing')
...
#core 1st order at different angular positions
fig1, ax1 = plt.subplots(nrows = 1, ncols = 1, constrained_layout = True, figsize=(12,8))
fig1.suptitle('D spacing per frame for skin root 3 sample 7 extrusion and annealing')
