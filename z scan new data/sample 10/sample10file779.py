...
#FILE 442 DOCS
file442_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/sample 10/FILE7791.xlsx'
file='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/z scan new data/sample 10/file779 ratios.xlsx'
...
plt.grid()
ax1.set_title('FILE 779 - sample 10 thickness 0.55-0.68 mm')
plt.show()
...
plt.title('FILE 779 - sample 10 thickness 0.55-0.68 mm')
plt.xlabel('Frame')
...
ax1.set_xlabel('Frame')
plt.grid()
ax1.set_title('FILE 779 sample 10 0.55-0.68 mm thickness')
plt.show()
...
(ax1, ax2) = axs
fig10.suptitle('FILE 779 sample 10 thickness 0.55-0.68 mm')
...
dfsr3= (df2skinroot3.iloc[660:745,:] - 220)
dfsr3[dfsr3 < 0] = 0
(df2skinroot3.iloc[660:745,:] - 220).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for skin at 180 degrees ' )
plt.show()
...
for i in range(1, d+1):
    ...
    x_data, u_data[i] = (dfskinroot3['DEG'].loc[660:744], dfsr3[i])
    #xdata =x_data/max(x_data)
    #ydata[i] =y_data[i]/max(y_data[i])
...
dfs1[dfs1 < 0]=0
dfs1.iloc[595:845,:].plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = '1st order peaks for skin ' )
plt.show()
...
for i in range(1, e+1):
    ...
    x_data, n_data[i] = (dfskin1['DEG'].loc[595:844], dfsr1[i])
    #xdata =x_data/max(x_data)
    #ydata[i] =y_data[i]/max(y_data[i])
...
dfcr3= (df2coreroot3.iloc[245:340,:] - 220)
dfcr3[dfcr3 < 0] = 0
(df2coreroot3.iloc[245:340,:] - 220).plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for core ' )
plt.show()



#all core root 3
dfcr3clean = (df2coreroot3 - 220)
dfcr3clean[dfcr3clean < 0]=0
dfcr3clean.plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = 'Root 3 peaks for core overall ' )
plt.show()

dfcr32 = dfcr3clean.iloc[950:1040, :]
...
for i in range(1, g+1):
    ...
    x_data, o_data[i] = (dfcoreroot3['DEG'].loc[245:339], dfcr3[i])
    #xdata =x_data/max(x_data)
    #ydata[i] =y_data[i]/max(y_data[i])
...
dfc1 = (df2core1-250)
dfc1[dfc1 < 0]=0
dfcr1 = dfc1.iloc[210:500, :]

#core1st order 270 deg
dfcr12 = dfc1.iloc[900:1200, :]
...
dfc1[dfc1 < 0]=0
dfc1.iloc[210:500,:].plot(figsize=[12,12], legend= False, ylim = [0, 1000], title = '1st order peaks for core ' )
plt.show()
...
for i in range(1, h+1):
    ...
    x_data, v_data[i] = (dfcore1['DEG'].loc[210:499], dfcr1[i])
    #xdata =x_data/max(x_data)
    #ydata[i] =y_data[i]/max(y_data[i])
...
core1maxanglesss[core1maxanglesss == core1maxanglesss[396]]=0
core1minanglesss = np.array(core1minangless)
core1minanglesss[core1minanglesss == core1minanglesss[396]]=0
print(core1minanglesss[0])
FWHMcore1 = np.subtract(core1maxanglesss, core1minanglesss) 
FWHMcore1 = np.where((FWHMcore1 > 65), nan, FWHMcore1)   
...
plt.figure(figsize = (12, 8))
plt.title('1st order core FWHM sample 10 extrusion and annealing')
...
core3maxanglesss[core3maxanglesss == core3maxanglesss[63]] = 0
core3minanglesss = np.array(core3minangless)
core3minanglesss[core3minanglesss == core3minanglesss[63]] = 0
...
plt.figure(figsize = (12, 8))
plt.title('root 3 core FWHM sample 10 extrusion and annealing')
...
FWHMskin1 = np.where((FWHMskin1 > 30), nan, FWHMskin1)    
plt.figure(figsize = (12, 8))
...
plt.figure(figsize = (12, 8))
plt.title('1st order skin FWHM sample 10 extrusion and annealing')
...
skin3maxanglesss[skin3maxanglesss == skin3maxanglesss[170]] = 0
skin3minanglesss = np.array(skin3minangless)
skin3minanglesss[skin3minanglesss == skin3minanglesss[170]] = 0

FWHMskin3 = np.subtract(skin3maxanglesss, skin3minanglesss)  
FWHMskin3 = np.where((FWHMskin3 > 20), nan, FWHMskin3) 
...
plt.figure(figsize = (12, 8))
plt.title('root 3 skin FWHM sample 10 extrusion and annealing')
