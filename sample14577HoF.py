...
#FILE 442 DOCS
file442_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/hof577sample14.xlsx'
...
dfc1 = (df24421storder-410)
dfc1[dfc1 < 0]=0
linesnew = dfc1.iloc[250:340,:].plot.line(legend=False, grid = True)
plt.show()

dfc3 = (df2442root3-360)
dfc3[dfc3 < 0]=0
linesnew = dfc3.iloc[250:360,:].plot.line(legend=False, grid = True)
plt.show()
