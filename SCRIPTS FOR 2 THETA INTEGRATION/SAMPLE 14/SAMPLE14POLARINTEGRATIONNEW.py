...
#FILE 462 DOCS
file462_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE 14/FILE577THETA.xlsx'
...
#
file496_1storder='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE 14/FILE596THETA.xlsx'
...
(ax1, ax2), (ax3, ax4) = axs
ax1.set_xlim(xmin=0.34, xmax=0.58)
ax1.set_ylim(ymin=0, ymax=2400)
ax2.set_xlim(xmin=0.34, xmax=0.58)
ax2.set_ylim(ymin=0, ymax=5000)
ax3.set_xlim(xmin=0.34, xmax=0.58)
ax3.set_ylim(ymin=0, ymax=3600)
ax4.set_xlim(xmin=0.34, xmax=0.58)
ax4.set_ylim(ymin=0, ymax=6000)
