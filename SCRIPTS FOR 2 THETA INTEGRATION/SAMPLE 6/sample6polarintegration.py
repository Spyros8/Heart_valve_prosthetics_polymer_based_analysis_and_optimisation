...
#FILE 462 DOCS
file462_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE 6/FILE642THETA.xlsx'


#FILE 510 DOCS
file510_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE 6/FILE654THETA.xlsx'

#FILE 503 DOCS
file503_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE 6/FILE666THETA.xlsx'

#
file496_1storder='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE 6/FILE689THETA.xlsx'
...
df4961storder = xl.parse('Sheet1'); 

#xaxis in degrees [azimuthal angles]
dfdegrees1=df4961storder.iloc[:,0]
...
#print(areatrap4961storder_array)
...
fig12.suptitle('SAMPLE 6 1st order peaks')
...
ax4.set_xlim(xmin=0.34, xmax=0.54)
ax4.set_ylim(ymin=0, ymax=2600)
ax1.set_title('12 mm from injection pt')
ax1.set_xlabel('2 theta')
ax1.set_ylabel('intensity')
ax2.set_title('27 mm from injection pt')
...
ax4.set_xlabel('2 theta')
ax4.set_ylabel('intensity')
fig13.suptitle('SAMPLE 6 root 3 and 2nd order peaks')
df_list = [df24421storder, df25051storder, df24991storder, df24961storder]
# plot counter
n = 0
for r in range(2):
...
df442root3max = df24421storder.iloc[24:33,:].max()#24 33
...
fig14.suptitle('SAMPLE 6 ROOT 3 PEAK')
ax1.set_title('12 mm from injection pt')
ax1.set_xlabel('frame')
...
fig15.suptitle('SAMPLE 6 1st order peak max')
ax1.set_title('12 mm from injection pt')
ax1.set_xlabel('frame')
