...
(ax1, ax2), (ax3, ax4) = axs
ax1.set_xlim(xmin=0.32, xmax=0.58)
ax1.set_ylim(ymin=0, ymax=4600)
ax2.set_xlim(xmin=0.32, xmax=0.58)
ax2.set_ylim(ymin=0, ymax=3000)
ax3.set_xlim(xmin=0.32, xmax=0.58)
ax3.set_ylim(ymin=0, ymax=3000)
ax4.set_xlim(xmin=0.32, xmax=0.58)
ax4.set_ylim(ymin=0, ymax=8000)
...
fig14.suptitle('SAMPLE 3 ROOT 3 PEAK')
...
fig15.suptitle('SAMPLE 3 1st ORDER PEAK')
