...
#FILE 462 DOCS
file462_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE 11/FILE584THETA.xlsx'


#FILE 510 DOCS
file510_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE 11/FILE602THETA.xlsx'

#FILE 503 DOCS
file503_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE 11/FILE614THETA.xlsx'

#
file496_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE 11/FILE560THETA.xlsx'
...
plt.setp(axs, xticks= np.arange(0, 181, 10))
...
fig12.suptitle('SAMPLE 11 1st order peaks')
...
(ax1, ax2), (ax3, ax4) = axs
ax1.set_xlim(xmin=0.34, xmax=0.54)
ax1.set_ylim(ymin=0, ymax=2000)
ax2.set_xlim(xmin=0.34, xmax=0.54)
ax2.set_ylim(ymin=0, ymax=1400)
ax3.set_xlim(xmin=0.34, xmax=0.54)
...
ax4.set_xlabel('2 theta')
ax4.set_ylabel('intensity')
fig13.suptitle('SAMPLE 11 root 3 and 2nd order peaks')
df_list = [df24421storder, df25051storder, df24991storder, df24961storder]
# plot counter
n = 0
for r in range(2):
...
(ax1, ax2), (ax3, ax4) = axs
fig14.suptitle('SAMPLE 11 ROOT 3 PEAK')
ax1.set_title('12 mm from injection pt')
ax1.set_xlabel('frame')
...
for r in range(2):
    for c in range(2):
        df_list[n].plot(ax=axs[r,c], legend = False)#, xticks = range(0, 181, 10))
        n = n + 1
...
fig15.suptitle('SAMPLE 11 1st order peak max')
ax1.set_title('12 mm from injection pt')
ax1.set_xlabel('frame')
