...
#FILE 462 DOCS
file462_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE 7/FILE635THETA.xlsx'


#FILE 510 DOCS
file510_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE 7/FILE646THETA.xlsx'

#FILE 503 DOCS
file503_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE 7/FILE657THETA.xlsx'

#
file496_1storder='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE 7/FILE672THETA.xlsx'
...
fig12.suptitle('SAMPLE 7 1st order peaks')
...
(ax1, ax2), (ax3, ax4) = axs
ax1.set_xlim(xmin=0.38, xmax=0.5)
ax1.set_ylim(ymin=0, ymax=800)
ax2.set_xlim(xmin=0.38, xmax=0.5)
ax2.set_ylim(ymin=0, ymax=800)
ax3.set_xlim(xmin=0.38, xmax=0.5)
ax3.set_ylim(ymin=0, ymax=800)
ax4.set_xlim(xmin=0.38, xmax=0.5)
ax4.set_ylim(ymin=0, ymax=1000)
ax1.set_title('12 mm from injection pt')
ax1.set_xlabel('2 theta')
ax1.set_ylabel('intensity')
ax2.set_title('27 mm from injection pt')
...
ax4.set_xlabel('2 theta')
ax4.set_ylabel('intensity')
fig13.suptitle('SAMPLE 7 root 3 and 2nd order peaks')
df_list = [df24421storder, df25051storder, df24991storder, df24961storder]
# plot counter
n = 0
for r in range(2):
...
fig14.suptitle('SAMPLE 7 ROOT 3 PEAK')
ax1.set_title('12 mm from injection pt')
ax1.set_xlabel('frame')
...
(ax1, ax2), (ax3, ax4) = axs
fig15.suptitle('SAMPLE 7 1st order peak max')
ax1.set_title('12 mm from injection pt')
ax1.set_xlabel('frame')
