...
(ax1, ax2), (ax3, ax4) = axs
ax1.set_xlim(xmin=0.36, xmax=0.56)
ax1.set_ylim(ymin=0, ymax=1600)
ax2.set_xlim(xmin=0.36, xmax=0.56)
ax2.set_ylim(ymin=0, ymax=2400)
ax3.set_xlim(xmin=0.36, xmax=0.56)
ax3.set_ylim(ymin=0, ymax=1600)
ax4.set_xlim(xmin=0.36, xmax=0.56)
ax4.set_ylim(ymin=0, ymax=3400)
