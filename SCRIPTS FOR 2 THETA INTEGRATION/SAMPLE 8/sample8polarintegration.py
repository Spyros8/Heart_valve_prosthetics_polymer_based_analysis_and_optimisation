...
#FILE 462 DOCS
file462_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE 8/FILE514THETA.xlsx'


#FILE 510 DOCS
file510_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE 8/FILE523THETA.xlsx'

#FILE 503 DOCS
file503_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE 8/FILE532THETA.xlsx'

#
file496_1storder='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE 8/FILE542THETA.xlsx'
...
plt.setp(axs, xticks= np.arange(0, 81, 5))
...
fig12.suptitle('SAMPLE 8 1st order peaks')
...
(ax1, ax2), (ax3, ax4) = axs
ax1.set_xlim(xmin=0.36, xmax=0.5)
ax1.set_ylim(ymin=0, ymax=800)
ax2.set_xlim(xmin=0.36, xmax=0.5)
ax2.set_ylim(ymin=0, ymax=1200)
ax3.set_xlim(xmin=0.36, xmax=0.5)
ax3.set_ylim(ymin=0, ymax=800)
ax4.set_xlim(xmin=0.36, xmax=0.5)
ax4.set_ylim(ymin=0, ymax=1200)
ax1.set_title('12 mm from injection pt')
ax1.set_xlabel('2 theta')
ax1.set_ylabel('intensity')
ax2.set_title('27 mm from injection pt')
...
ax4.set_xlabel('2 theta')
ax4.set_ylabel('intensity')
fig13.suptitle('SAMPLE 8 root 3 and 2nd order peaks')
df_list = [df24421storder, df25051storder, df24991storder, df24961storder]
# plot counter
n = 0
for r in range(2):
...
(ax1, ax2), (ax3, ax4) = axs
fig14.suptitle('SAMPLE 8 ROOT 3 PEAK')
ax1.set_title('12 mm from injection pt')
ax1.set_xlabel('frame')
...
for r in range(2):
    for c in range(2):
        df_list[n].plot(ax=axs[r,c], legend = False)#, xticks = range(0, 81, 5))
        n = n + 1
...
fig15.suptitle('SAMPLE 8 1st order peak max')
ax1.set_title('12 mm from injection pt')
ax1.set_xlabel('frame')
