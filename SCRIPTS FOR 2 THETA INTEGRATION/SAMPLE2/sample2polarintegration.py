...
#FILE 462 DOCS
file462_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE2/FILE462THETA.xlsx'


#FILE 510 DOCS
file510_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE2/FILE510THETA.xlsx'

#FILE 503 DOCS
file503_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE2/FILE503THETA.xlsx'

#
file496_1storder='C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/SCRIPTS FOR 2 THETA INTEGRATION/SAMPLE2/FILE496THETA.xlsx'
...
ax2.set_ylim(ymin=0, ymax=900)
ax3.set_xlim(xmin=0.34, xmax=0.5)
ax3.set_ylim(ymin=0, ymax=900)
ax4.set_xlim(xmin=0.34, xmax=0.5)
ax4.set_ylim(ymin=0, ymax=900)
fig12.suptitle('SAMPLE 2 1st order peaks')
...
ax4.set_xlabel('2 theta')
ax4.set_ylabel('intensity')
fig13.suptitle('SAMPLE 2 root 3 and 2nd order peaks')
df_list = [df24421storder, df25051storder, df24991storder, df24961storder]
# plot counter
n = 0
for r in range(2):
...
lines15 = df442root3max.plot.line(legend=False, grid = True, title='FILE 462 (2)')

df505root3max = df25051storder.iloc[24:33,:].max()

lines16 = df505root3max.plot.line(legend=False, grid = True, title = 'FILE 462 (2)')

df499root3max = df24991storder.iloc[24:33,:].max()

lines17 = df499root3max.plot.line(legend=False, grid = True, title = 'FILE 462 (2)')

df496root3max = df24961storder.iloc[24:33,:].max()

lines18 = df496root3max.plot.line(legend=False, grid = True, title = 'FILE 462 (2)')

#plot all frame intensities for all files
fig14, axs = plt.subplots(nrows = 2, ncols = 2, constrained_layout = True, figsize=(12,8))
(ax1, ax2), (ax3, ax4) = axs
fig14.suptitle('SAMPLE 2 ROOT 3 PEAK')
ax1.set_title('12 mm from injection pt')
ax1.set_xlabel('frame')
...
for r in range(2):
    for c in range(2):
        df_list[n].plot(ax=axs[r,c], legend = False, xticks = range(0, 101, 5))
        n = n + 1
...
lines19 = df442root3max.plot.line(legend=False, grid = True, title='FILE 462 (2)')

df5051stordermax = df25051storder.iloc[6:13,:].max()

lines20 = df5051stordermax.plot.line(legend=False, grid = True, title = 'FILE 510 (2)')

df4991stordermax = df24991storder.iloc[6:13,:].max()

lines21 = df4991stordermax.plot.line(legend=False, grid = True, title = 'FILE 503 (2)')

df4961stordermax = df24961storder.iloc[6:13,:].max()

lines22 = df4961stordermax.plot.line(legend=False, grid = True, title = 'FILE 496 (2)')

#plot all frame intensities for all files
fig15, axs = plt.subplots(nrows = 2, ncols = 2, constrained_layout = True, figsize=(12,8))
(ax1, ax2), (ax3, ax4) = axs

fig15.suptitle('SAMPLE 2 1st order peak max')
ax1.set_title('12 mm from injection pt')
ax1.set_xlabel('frame')
