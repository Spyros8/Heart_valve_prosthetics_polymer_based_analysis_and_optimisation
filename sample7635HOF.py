...
#FILE 442 DOCS
file442_1storder= 'C:/Users/Spyros/.spyder-py3/RESEARCH PROJECT RELEVANT IIB/HOFonfile635sample7closest.xlsx'
...
dfc1 = (df24421storder-500)
dfc1[dfc1 < 0]=0
linesnew = dfc1.iloc[1000:1500,:].plot.line(legend=False, grid = True)
plt.show()

dfc3 = (df2442root3-400)
dfc3[dfc3 < 0]=0
linesnew = dfc3.plot.line(legend=False, grid = True)
plt.show()
...
plt.grid()
ax1.set_title('FILE 635 - sample 7 1st order peaks')
plt.show()
